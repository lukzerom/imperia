      ...
      <div className="implementation2">
        ...
        <div className="div3" data-aos="fade-up">
          <p>
            ...
            maxime magnam dolore, quod tempore ut in odit quasi qui obcaecati
            sunt ipsam nam sapiente dolor accusantium nostrum earum dolores
            repudiandae vitae iusto id harum animi et explicabo. Ad pariatur non
            tempore debitis alias dolor porro ut in. Quaerat quam accusamus
            voluptatibus, nobis alias odio possimus molestias dolor ab ess
          </p>
        </div>
        <div className="div4">
