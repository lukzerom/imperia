...
const Implementation1 = () => {
  ...
  <div className="div2"> <h1>Kupper glass</h1>  </div>
  <div className="div3"> <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusamus repellat dolor harum assumenda! Officia, asperiores, veritatis accusantium dolorum omnis itaque ullam eum explicabo enim ad libero delectus illum reprehenderit architecto?
  ...
  <div className="div4">  <h4 className="sideText">Kupper Glass</h4> <img className="img" src={img29} alt=""/> </div>
  <div className="div5">  <h4 className="sideText">Kupper Glass</h4> <img className="img" src={img31} alt=""/> </div>
  <div className="div6 darkblue"> </div>
  <div className="div7">  <h4 className="sideText">Kupper Glass</h4> <img className="img" src={img32} alt=""/> </div>
  </div>);
};
